...
<html>
    <head>
        ...
        <script type="text/javascript" src="/assets/javascript/downloadSpeed.js"></script>
    </head>
    <body>
        <div class="website">
            ...
            <div id="main">
                ...
                <section class="content" style="width:80%;">
                    ...
                    <img data-lazyload="images/loadingExampleBaseline01.jpg" id="downloadSpeedTestImage">
